...
% J2 = imnoise(Agr1,'gaussian',0,400/255^2);
% for Ag=0.2:0.2:0.8
%    for Ap=0.2:0.2:0.8
%         for Ar=0.2:0.2:0.8
%             for Al = 0.2:0.2:0.8
...
%                             ftrN(4,i,j) = (1-Ag)*(d_sorted(1)+d_sorted(2))/2;
%                             ftrNF(4,i,j) = Ag+(1-Ag)*betal*(1-ftrN(4,i,j));
%                             ftrF(4,i,j) = (1-Ag)*(1-betal)*(1-ftrN(4,i,j));
...
% %                             
                            ...
                            ftrF(9,i,j) = (1-Al)*(1-betag)*(1-ftrN(9,i,j));
                              ...
                              mN(i,j) = ftrN(ig,i,j)*ftrN(ir,i,j)*ftrN(il,i,j)*ftrN(ip,i,j);
